...
init python:
    ...
    Replay_items = []
    Replay_items.append(ReplayItem("alex doggy1","replay_alex_doggy","Will and Alex doggy"))
    Replay_items.append(ReplayItem("kim fondle 1","kim_pov1","Kim in Will's home"))
    Replay_items.append(ReplayItem("kim and jamie handjob 1","replay_kim_jamie_handjob","Kim and Jamie handjob"))
    Replay_items.append(ReplayItem("kim and alex chat 1","replay_kim_and_alex_chat","Kim and Alex chat"))
    Replay_items.append(ReplayItem("kim spies on alex and will 1","replay_kim_spies_on_will","Kim spies on Will"))
    Replay_items.append(ReplayItem("jamieandwill cuddlenight","replay_sleepover","Jamie and Will sleepover"))
    Replay_items.append(ReplayItem("will bulgeselfie","will_and_diane_text1","Will and Diane chat 1"))
    Replay_items.append(ReplayItem("kim dildo1","kim_pov2","Kim sucks a Dildo"))
    Replay_items.append(ReplayItem("diane lewd2","diane_pov1","Will and Diane chat 2"))
    Replay_items.append(ReplayItem("kim and jamie standing","kim_date3","Kim and Jamie date"))
    Replay_items.append(ReplayItem("diane nude text","will_and_diane_text2","Will and Diane sexting"))
    Replay_items.append(ReplayItem("diane and will side 1","will_and_diane_sex1","Will and Diane app date"))
    Replay_items.append(ReplayItem("kim and alex chat 2","kim_dildo1","Kim rides a dildo"))
    Replay_items.append(ReplayItem("diane and will frontdoor 2","will_and_diane_sex1_aftermath","Diane and Will sex aftermath"))
    Replay_items.append(ReplayItem("kim and jamie doggy 1","football_aftermath","Football aftermath"))
    Replay_items.append(ReplayItem("kim and will bj bulge","party","Kim and Will at party and after events"))
    Replay_items.append(ReplayItem("diane will carry 0","diane_and_will_breastmilk","Diane and Will breastmilk"))
    Replay_items.append(ReplayItem("kim bbc masturbating","kim_browsing","Kim bbc masturbating"))
    Replay_items.append(ReplayItem("william kim dance 1","kim_and_will_date","Kim and Will date and party"))
    ...
    Replay_items.append(ReplayItem("tv tease 1","tv_tease","Kim TV tease"))
    Replay_items.append(ReplayItem("diane jamie watch 5","jamie_witnesses","Jamie helps Will (NTS)"))
    Replay_items.append(ReplayItem("diane will 69 1","diane_wwe_before","Diane WWE"))
    Replay_items.append(ReplayItem("yelena dressup 3","yelena_secret","Yelena secret"))
