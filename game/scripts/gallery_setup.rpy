...
init python:
    ...
    gallery_items.append(GalleryItem("Jamie cat photos", ["push down 1","push down 2"]))
    gallery_items.append(GalleryItem("Hex", ["hex 2", "hex 1"]))
    gallery_items.append(GalleryItem("Twist", ["twist 1", "twist 2", "twist 3"]))
    gallery_items.append(GalleryItem("Tcg Jamie", ["tcg jamie 3","tcg jamie 2"]))
    gallery_items.append(GalleryItem("Jamie and Will dinner", ["jamie will diner 1", "jamie will diner 2"]))
    gallery_items.append(GalleryItem("Jamie vibrator", ["jamie vibe 3","jamie vibe 2", "jamie vibe 1","jamie vibe 6","jamie vibe 2","jamie vibe 6","jamie vibe 2","jamie vibe 6","jamie vibe 2","jamie vibe 1","jamie vibe 3"]))
    gallery_items.append(GalleryItem("Kim plaps Jamie", ["jamie plap 2","jamie plap 1","jamie plap 2","jamie plap 3","jamie plap 4","lplaps 1","lplaps 2","lplaps 3","jamie plap 7"]))
    gallery_items.append(GalleryItem("Jamie frott", ["jamie frott cage", "jamie frott chub 1","jamie frott chub 2","frottage 1","frottage 2","jamie frott 1","frottage 3","jamie frott 6"]))
    gallery_items.append(GalleryItem("Jamie mirror lingerie", ["jamie mirror lingerie"]))
    gallery_items.append(GalleryItem("Jamie raven", ["raven pic 1", "raven pic 2"]))
    gallery_items.append(GalleryItem("Drunk Jamie and Will smooch", ["jamie will smooch"]))
    gallery_items.append(GalleryItem("Kim first raw sex", ["nelson 1","nelson 2","nelson 3","nelson 4","nelson 2","nelson 7","kimmie nelson 1","nelson 7","nelson 4","kimmie nelson 2","nelson 11","nelson 12"]))
    gallery_items.append(GalleryItem("Kim pronebone raw sex", ["pronebone 1","kimmie pronebone 1","kimmie pronebone 2","pronebone 7"]))
    gallery_items.append(GalleryItem("Kim succumb", ["kim succumb 1","kim succumb 2"]))
    gallery_items.append(GalleryItem("TV tease", ["tv tease 1","tv tease 2","tv tease 4","tv tease 5","tv tease 6"]))
    gallery_items.append(GalleryItem("TV tease continues NTR", ["tv tease 9", "tv ntr 1","tv ntr 2", "tv tease 15", "tv ntr 3", "tv tease 21", "tv ntr 4", "tv ntr 5", "tv tease 30","tv tease 32"]))
    gallery_items.append(GalleryItem("TV tease continues NTS", ["tv tease 7", "tv ntrs 1","tv ntrs 2","tv ntrs 3","tv tease 22","tv tease 23","tv tease 28","tv tease 29","tv tease 31"]))
    gallery_items.append(GalleryItem("Will flex", ["will flex 1","will flex 2","will flex 3"]))
    gallery_items.append(GalleryItem("Jamie helps", ["jamie help 1","jamie help 2","jamie help 3","jamie help 5","jamie help 6","jamie help 4","jamie help 6","jamie first nts 1", "jamie first nts 2", "jamie help 10"]))
    gallery_items.append(GalleryItem("Jamie watches Diane in disguise", ["diane jamie watch 1", "diane jamie watch 2", "jamie watches diane doggy 1", "jamie watches diane doggy 2","diane jamie watch 5"]))
    gallery_items.append(GalleryItem("Diane and Will 69", ["diane will 69 1","diane will 69 2","diane will 69 3","diane will 69 4","diane 69s will 1", "diane 69s will 2","diane will 69 8"]))
    gallery_items.append(GalleryItem("Diane First Raw sex", ["diane horsey 1","diane horsey 2","diane horsey 3", "diane first raw 1", "diane first raw 2","diane horsey 11","diane horsey 10","diane horsey 11","diane horsey 10","diane horsey 11","diane first raw 3", "diane horsey 12"]))
    gallery_items.append(GalleryItem("Yelena dressup", ["yelena dressup 1","yelena dressup 2","yelena dressup 3",]))
